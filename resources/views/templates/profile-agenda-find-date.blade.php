                                    ...
                                    <div class="row find-date my-4">
                                        <div class="col-12 col-md-6 find-date-leftside py-2 ">
                                            <div class="row d-flex align-items-center" style="height: 100%">
                                                <div class="col-12">
                                                    <h4 class="text-center mb-4"><strong>Encontrar Cirta</strong></h4>

                                                    <div class="form-group">
                                                        <input type="date" placeholder="Elige la fecha" class="form-control transparent">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" placeholder="La cita es con" class="form-control transparent">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" placeholder="URL" class="form-control transparent">
                                                    </div>
                                                    <div class="form-group">
                                                        <button class="btn btn-custom-red btn-rounded">ENTRAR</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
