                        ...
                        <div class="col-12">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-agenda" role="tabpanel" aria-labelledby="nav-agenda-tab">
                                    <form action="">
                                        <fieldset>
                                            <legend class="title-red">Anúnciate</legend>
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label>Tema</label>
                                                        <input type="text" name="name" class="form-control" placeholder="Nombre de clase o curso" required>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <button class="btn btn-custom-red">ANÚNCIATE</button>
                                                    </div>
                                                </div>                                                
                                            </form>
                                        </fieldset>
