                        ...
                        <div class="col-12">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-agenda" role="tabpanel" aria-labelledby="nav-agenda-tab">
                                    <div class="row plans-wrapper d-flex align-items-center justify-content-center">
                                        <div class="col-12 col-md-4 plans">
                                            <div class="plans-header">
                                                <h4 class="plans-header-title">plan premium</h4>
                                                <p class="plans-header-price">$ 510.00</p>
                                                <small class="plan-header-subtitle">plan mensual</small>
                                            </div>
                                        ...
                                        <div class="col-12 col-md-4 plans">
                                            <div class="plans-header">
                                                <h4 class="plans-header-title">plan premium</h4>
                                                <p class="plans-header-price">$ 499.00</p>
                                                <small class="plan-header-subtitle">plan mensual</small>
                                            </div>
                                            <div class="plans-body">
                                                <ul>
