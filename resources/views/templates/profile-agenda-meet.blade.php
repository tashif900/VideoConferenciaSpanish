                        ...
                        <div class="col-12">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-agenda" role="tabpanel" aria-labelledby="nav-agenda-tab">
                                    <form action="">
                                        <fieldset>
                                            <legend>PROGRAMAR REUNION</legend>
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label>Fecha</label>
                                                        <input type="date" class="form-control" placeholder="" name="start_hour" required>
                                                    </div>
                                                    <div class="col">
                                                        <label>Costo</label>
                                                        <input type="text" class="form-control" name="price" required>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-5 col-md-5">
                                                    <input type="text" class="form-control" placeholder="Escribe el correo">
                                                </div>
                                                <div class="col-2 col-md-2">
                                                    <button class="btn btn-custom-blue"><i class="ti-plus"></i></button>
                                                </div>
                                            </div>
                                            <div class="row mt-4">
                                                <div class="col-12">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td>Mark</td>
                                                                <td>Otto@rodmensoft.test</td>
                                                              </tr>
                                                              <tr>
                                                                <td>Jacob</td>
                                                                <td>Thornton@rodmensoft.test</td>
                                                              </tr>
                                                              <tr>
                                                                <td>Larry</td>
                                                                <td>theBird@rodmensoft.test</td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                    </div>
