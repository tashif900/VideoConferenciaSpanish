...
<head>
    ...
    <title>Tu Solicitud de retiro fue rechazada</title>
...
<body>
    ...
    <div class="main">
        ...
        <p>Su solicitud de retiro de fecha {{ date('d-m-Y', strtotime($date)) }} ha sido rechazada por su banco, por favor verifique su número de cuenta o comúniquese al correo: pagos@zurviz.com</strong>.</p>

        <div class="footer">
            <P>¿Quieres enterarte cuando esté en oferta en oferta los cursos y clases?</P>
