            ...
            <div class="row justify-content-center hvh-100 align-items-center">
                <div class="col-12 col-md-9 text-center">
                    ...
                    <form action="">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <button class="btn btn-custom-social facebook"><img src="{{ asset('img/facebook-icon.png') }}"> Registrarme con Facebook</button>
                            </div>
                            <div class="col text-right">
                                <button class="btn btn-custom-social google"><img src="{{ asset('img/google-icon.png') }}"> Registrarme con Google</button>
                            </div>
                        </div>
                    </form>
                </div>
