...
@section('title', 'Documentos de Cuenta')
...
@section('content')
    <div class="card">
        <div class="card-header text-dark"><h2>Documentos de Cuenta</h2>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
                    <h5 id="modal-title" class="modal-title">Nuevo documentos de cuenta</h5>
                ...
                <div class="modal-body">
                    <form method="post" id="formcountry" name="formcountry">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Ingresar el nombre">
                        </div>
                        <div class="form-group">
...
@section('js')
    ...
    <script>
        ...
        $('#btnAdd').click(function() {
            clearinput();
            $('#modal-title').html('Nuevo documentos de cuenta');
            $('#id').val('');
            $('#name').val('');
            $('#state').val(1);
        ...
        $('#btnSave').click(function() {
            ...
            $.ajax({
                url: '{{route('savedocument_accounts')}}',
                type: 'post',
        ...
        $('body').on('click', '.delete', function() {
            ...
            $.ajax({
                    url: 'deletedocument_accounts/' + data['id'],
                    type: 'get',
                    'success': function(response) {
                        if(response == true)
        ...
        $('body').on('click', '.edit', function() {
            clearinput();
            $('#modal-title').html('Editar documentos de cuenta');
