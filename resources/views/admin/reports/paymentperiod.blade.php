...
@section('title', 'Reporte de los pagos por periodo')
...
@section('content')
    <div class="card">
        <div class="card-header text-dark"><h2></h2>
            <div class="card-header"><h3>Reporte de los pagos por periodo</h3>
        </div>
...
@section('js')
    ...
    <script>
        let tb_data = $('#tb_data').DataTable({
            ...
            'scrollX': 300,
            'ajax': {
                'url': '{{route('dtReportsPaymentPeriod')}}',
                'type' : 'get',
            },
            'language': {
