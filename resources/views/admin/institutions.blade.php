...
@section('content')
    ...
    <div class="modal" role="dialog" tabindex="-1" id="mdlInstitution">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="formInstitution" name="formInstitution">
                        <input type="hidden" id="id" name="id">
                        <div class="form-group">
                            <label for="name">Nombre *</label>
                            <input type="text" class="form-control" id="description" name="description" placeholder="Ingresar su description" required>
                        </div>
                        <div class="form-group">
...
@section('js')
    ...
    $('#btnSave').click(function() {
        ...
        let data = $('#formInstitution').serialize();
        $.ajax({
            url: '{{route('saveInstitutions')}}',
            type: 'post',
            data: data + '&_token=' + '{{ csrf_token() }}',
            'success': function(response) {
                if(response == true) {
