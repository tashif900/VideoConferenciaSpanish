                        ...
                        <div class="card-white">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <fieldset>
                                            <legend id="cabecera_hiden">Nuevo Curso</legend>
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        ...
                                                        <textarea maxlength="1000" name="description" class="form-control" v-model="description" placeholder="Descripción" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        ...
                                                        <div v-if="verificaBrowser==='Safari'">
                                                            <datetime format="YYYY-MM-DD" class="form-control2" id="pstar"  v-model="promotionStart"></datetime>
                                                        </div>
                                                        <div v-else>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div v-if="verificaBrowser==='Safari'">
                                                            <datetime format="YYYY-MM-DD" class="form-control2" id="pend" v-model="promotionEnd"></datetime>
                                                        </div>
                                                        <div v-else>
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-12 col-md-6">
                                                        ...
                                                        <div v-if="verificaBrowser==='Safari'">
                                                            <datetime format="YYYY-MM-DD" class="form-control2" id="courseStart"  v-model="start_hour"></datetime>
                                                        </div>
                                                        <div v-else>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            verificaCourse(){
                let verifica = false;
                if (this.name && this.cSubtopic && this.description && this.type && this.numberClass && this.start_hour && this.price && this.filePhoto && this.filePreview) {
                    verifica = true;
                }else{
                    this.errors = [];
                    this.validatecourse=0;
                    if (!this.name) {
                    ...
                    if (!this.cSubtopic) {
                        this.errors.push('El subtema del curso es obligatorio.');
                    }
                    if (!this.description) {
                    ...
                    if (!this.filePreview){
                        this.errors.push('Debe seleccionar una imagen o subir un video de previzualización');
                    }
            ...
            saveCourse(){
                ...
                let url = '/api/store-course';
                /*if (this.previewType == '1'){
                    toastr.success('Espere un momento se está subiendo el Video Preview', "Mensaje del Sistema");
                }*/
                ...
                axios.post(url,formData, config).then(response => {
                    ...
                    //this.getCourses();
                    toastr.success('Se creó el curso correctamente.', "Mensaje del Sistema");
                    toastr.info('No olvide agregar clases a su curso, si no, no se mostrará.', "Mensaje del Sistema");
                    this.$router.push('edit-course/' + response.data.id);
                 //   console.log(response, 'Data Course');
                }).catch(error => {
                 //   console.log(error.response, 'Error registrar curso');

                    if (error.response.data){
                        if (error.response.data.name[0] == 'El nombre del curso no esta disponible.') {
                            this.errors.push('El nombre del curso no esta disponible.');
                        } else {
            ...
            store: function () {
                if (this.verificaCourse()) {
                    this.saveCourse();
                }else {
                    toastr.error('Ha ocurrido un error', 'Mensaje del sistema')
                }
            },
            scrollTop: function () {

                if (this.validatecourse === 0){
