...
class SendNotificationInstructorEveryMinutes extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->subject($subject)->view('mails.notification-instructor-every-five-minutes-mail');
    }
}
